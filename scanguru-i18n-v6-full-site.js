...
en: {
    ...
    home: {
        ...
        subtitle: 'Multi-modal ensemble AI analyzing 400+ pathologies across 8 modalities.',
        stat_modalities: '8+',
        stat_modalities_label: 'Modalities',
        stat_pathologies: '400+',
    ...
    // ═══════════════════════════════════════════════════════════════════════════════
    cxr: {
        badge: 'Chest X-Ray AI',
        title: 'Comprehensive Chest X-Ray Analysis',
        subtitle: 'AI-powered detection of 50+ thoracic pathologies with integrated cardiothoracic ratio measurement and critical finding prioritization.',
        stat1_value: '50+',
    ...
    ct_brain: {
        badge: 'CT Brain AI',
        title: 'Comprehensive CT Brain Analysis',
    ...
    mri: {
        badge: 'MRI Suite AI',
        title: 'Comprehensive MRI Analysis',
    ...
    msk: {
        badge: 'MSK X-Ray AI',
        title: 'Musculoskeletal X-Ray Analysis',
    ...
    dental: {
        badge: 'Dental AI',
        title: 'Comprehensive Dental Imaging Analysis',
    ...
    ultrasound: {
        badge: 'Ultrasound AI',
        title: 'Ultrasound Imaging Analysis',
...
de: {
    ...
    home: { badge: 'Kostenloser Plan Verfügbar', title: 'Die Komplette KI-Plattform für Medizinische Bildgebung', subtitle: 'Multi-modale Fusions-KI analysiert 400+ Pathologien in 8 Modalitäten.', stat_modalities: '8+', stat_modalities_label: 'Modalitäten', stat_pathologies: '400+', stat_pathologies_label: 'Pathologien', stat_languages: '83', stat_languages_label: 'Sprachen', stat_accuracy: '85-95%', stat_accuracy_label: 'Genauigkeit', cta_pilot: 'Kostenlos Registrieren', cta_try: 'Kostenlos Testen' },
    trust_bar: { title: 'Vertraut von Führenden Gesundheitseinrichtungen', hipaa: 'HIPAA-konform', gdpr: 'DSGVO-bereit', dicom: 'DICOM-kompatibel', hl7: 'HL7/FHIR-Integration', cloud: 'Cloud & On-Premise' },
    ...
    cta: { badge: 'Heute Starten', title: 'Bereit, Ihren Bildgebungs-Workflow zu Transformieren?', subtitle: 'Schließen Sie sich führenden Gesundheitseinrichtungen an.', btn_try: 'Kostenlos Testen', btn_pilot: 'Kostenlos Registrieren', btn_contact: 'Vertrieb Kontaktieren' },
    footer: { description: 'KI-gestützte Bildanalyse-Plattform für Gesundheitseinrichtungen weltweit.', col_platform: 'Plattform', col_modalities: 'Modalitäten', col_company: 'Unternehmen', col_resources: 'Ressourcen', col_legal: 'Rechtliches', copyright: '© 2026 ScanGuru. Alle Rechte vorbehalten.' },
    ...
    technology: { badge: 'Unsere Technologie', title: 'Enterprise-Grade KI-Architektur', subtitle: 'Aufgebaut auf bewährten Deep-Learning-Grundlagen mit Multi-Modell-Ensemble-Ansatz.' },
...
es: {
    ...
    home: { badge: 'Plan Gratuito Disponible', title: 'La Plataforma Completa de IA para Imágenes Médicas', subtitle: 'IA de fusión multimodal analiza 400+ patologías en 8 modalidades.', stat_modalities: '8+', stat_modalities_label: 'Modalidades', stat_pathologies: '400+', stat_pathologies_label: 'Patologías', stat_languages: '83', stat_languages_label: 'Idiomas', stat_accuracy: '85-95%', stat_accuracy_label: 'Precisión', cta_pilot: 'Registro Gratuito', cta_try: 'Prueba Gratis — Sin Cuenta' },
    trust_bar: { title: 'Confiado por Líderes en Salud', hipaa: 'Cumple HIPAA', gdpr: 'Listo para GDPR', dicom: 'Compatible DICOM', hl7: 'Integración HL7/FHIR', cloud: 'Nube y Local' },
    ...
    cta: { badge: 'Comience Hoy', title: '¿Listo para Transformar su Flujo de Imágenes?', subtitle: 'Únase a instituciones de salud líderes usando ScanGuru.', btn_try: 'Prueba Gratis', btn_pilot: 'Registro Gratuito', btn_contact: 'Contactar Ventas' },
    footer: { description: 'Plataforma de análisis de imágenes médicas con IA.', col_platform: 'Plataforma', col_modalities: 'Modalidades', col_company: 'Empresa', col_resources: 'Recursos', copyright: '© 2026 ScanGuru. Todos los derechos reservados.' },
    ...
    technology: { badge: 'Nuestra Tecnología', title: 'Arquitectura de IA Empresarial', subtitle: 'Construida sobre fundamentos de aprendizaje profundo probados.' },
...
fr: {
    ...
    home: { badge: 'Plan Gratuit Disponible', title: 'La Plateforme IA Complète pour l\'Imagerie Médicale', subtitle: 'IA de fusion multimodale analysant 400+ pathologies dans 8 modalités.', stat_modalities: '8+', stat_modalities_label: 'Modalités', stat_pathologies: '400+', stat_pathologies_label: 'Pathologies', stat_languages: '83', stat_languages_label: 'Langues', stat_accuracy: '85-95%', stat_accuracy_label: 'Précision', cta_pilot: 'Inscription Gratuite', cta_try: 'Essai Gratuit — Sans Compte' },
    trust_bar: { title: 'Approuvé par les Leaders de la Santé', hipaa: 'Conforme HIPAA', gdpr: 'Prêt RGPD', dicom: 'Compatible DICOM', hl7: 'Intégration HL7/FHIR', cloud: 'Cloud et Sur Site' },
    ...
    cta: { badge: 'Commencez Aujourd\'hui', title: 'Prêt à Transformer Votre Workflow d\'Imagerie?', subtitle: 'Rejoignez les institutions de santé leaders utilisant ScanGuru.', btn_try: 'Essai Gratuit', btn_pilot: 'Inscription Gratuite', btn_contact: 'Contacter les Ventes' },
    footer: { description: 'Plateforme d\'analyse d\'imagerie médicale par IA.', col_platform: 'Plateforme', col_modalities: 'Modalités', col_company: 'Entreprise', col_resources: 'Ressources', copyright: '© 2026 ScanGuru. Tous droits réservés.' },
    ...
    technology: { badge: 'Notre Technologie', title: 'Architecture IA de Niveau Entreprise', subtitle: 'Construite sur des fondations d\'apprentissage profond éprouvées.' },
...
hi: {
    ...
    home: { badge: 'मुफ्त प्लान उपलब्ध', title: 'मेडिकल इमेजिंग के लिए संपूर्ण AI प्लेटफ़ॉर्म', subtitle: 'मल्टी-मोडल फ्यूजन AI 8 मोडैलिटीज़ में 400+ पैथोलॉजीज़ का विश्लेषण करता है।', stat_modalities: '8+', stat_modalities_label: 'मोडैलिटीज़', stat_pathologies: '400+', stat_pathologies_label: 'पैथोलॉजीज़', stat_languages: '83', stat_languages_label: 'भाषाएं', stat_accuracy: '85-95%', stat_accuracy_label: 'सटीकता', cta_pilot: 'मुफ्त साइन अप करें', cta_try: 'मुफ्त आज़माएं — कोई खाता नहीं' },
...
zh: {
    ...
    home: { badge: '免费计划可用', title: '完整的医学影像AI平台', subtitle: '多模态融合AI在8种模态中分析400+种病理。', stat_modalities: '8+', stat_modalities_label: '模态', stat_pathologies: '400+', stat_pathologies_label: '病理', stat_languages: '83', stat_languages_label: '语言', stat_accuracy: '85-95%', stat_accuracy_label: '准确率', cta_pilot: '免费注册', cta_try: '免费试用 — 无需账户' },
...
ar: {
    ...
    home: { badge: 'خطة مجانية متاحة', title: 'المنصة الكاملة للتصوير الطبي بالذكاء الاصطناعي', subtitle: 'ذكاء اصطناعي متعدد الوسائط يحلل أكثر من 400 مرض في 8 طرائق.', stat_modalities: '8+', stat_modalities_label: 'طرائق', stat_pathologies: '400+', stat_pathologies_label: 'أمراض', stat_languages: '83', stat_languages_label: 'لغة', stat_accuracy: '85-95%', stat_accuracy_label: 'الدقة', cta_pilot: 'سجل مجاناً', cta_try: 'جرب مجاناً — بدون حساب' },
...
pt: {
    ...
    home: { badge: 'Plano Gratuito Disponível', title: 'A Plataforma Completa de IA para Imagem Médica', subtitle: 'IA de fusão multimodal analisa 400+ patologias em 8 modalidades.', cta_pilot: 'Registo Gratuito', cta_try: 'Experimentar Grátis' },
...
'pt-BR': {
    ...
    home: { badge: 'Plano Gratuito Disponível', title: 'A Plataforma Completa de IA para Imagem Médica', subtitle: 'IA de fusão multimodal analisa 400+ patologias em 8 modalidades.', cta_pilot: 'Cadastro Gratuito', cta_try: 'Teste Grátis' },
...
ja: {
    ...
    home: { badge: '無料プランあり', title: '医療画像のための完全なAIプラットフォーム', subtitle: 'マルチモーダル融合AIが8つのモダリティで400以上の病理を分析。', cta_pilot: '無料登録', cta_try: '無料で試す' },
...
ko: {
    ...
    home: { badge: '무료 플랜 이용 가능', title: '의료 영상을 위한 완전한 AI 플랫폼', subtitle: '멀티모달 융합 AI가 8개 모달리티에서 400개 이상의 병리를 분석합니다.', cta_pilot: '무료 등록', cta_try: '무료 체험' },
...
it: {
    ...
    home: { badge: 'Piano Gratuito Disponibile', title: 'La Piattaforma AI Completa per l\'Imaging Medico', subtitle: 'IA a fusione multimodale analizza 400+ patologie in 8 modalità.', cta_pilot: 'Registrati Gratis', cta_try: 'Prova Gratis' },
...
tr: {
    ...
    home: { badge: 'Ücretsiz Plan Mevcut', title: 'Tıbbi Görüntüleme için Eksiksiz AI Platformu', subtitle: 'Çok modlu füzyon AI 8 modalitede 400+ patolojiyi analiz eder.', cta_pilot: 'Ücretsiz Kaydol', cta_try: 'Ücretsiz Dene' },
...
ru: {
    ...
    home: { badge: 'Бесплатный план доступен', title: 'Полная AI-платформа для медицинской визуализации', subtitle: 'Мультимодальный ИИ анализирует 400+ патологий в 8 модальностях.', cta_pilot: 'Бесплатная регистрация', cta_try: 'Попробовать бесплатно' },
...
vi: {
    ...
    home: { badge: 'Gói miễn phí có sẵn', title: 'Nền tảng AI hoàn chỉnh cho Hình ảnh Y tế', subtitle: 'AI đa phương thức phân tích hơn 400 bệnh lý trên 8 phương thức.', cta_pilot: 'Đăng ký miễn phí', cta_try: 'Dùng thử miễn phí' },
...
id: {
    ...
    home: { badge: 'Paket Gratis Tersedia', title: 'Platform AI Lengkap untuk Pencitraan Medis', subtitle: 'AI fusi multimodal menganalisis 400+ patologi dalam 8 modalitas.', cta_pilot: 'Daftar Gratis', cta_try: 'Coba Gratis' },
...
th: {
    ...
    home: { badge: 'แผนฟรีพร้อมใช้งาน', title: 'แพลตฟอร์ม AI ครบวงจรสำหรับการถ่ายภาพทางการแพทย์', subtitle: 'AI แบบหลายโหมดวิเคราะห์โรคมากกว่า 400 ชนิดใน 8 โมดาลิตี้', cta_pilot: 'ลงทะเบียนฟรี', cta_try: 'ทดลองฟรี' },
...
pl: {
    ...
    home: { badge: 'Darmowy plan dostępny', title: 'Kompletna platforma AI dla obrazowania medycznego', subtitle: 'Wielomodalna fuzja AI analizuje ponad 400 patologii w 8 modalnościach.', cta_pilot: 'Zarejestruj się za darmo', cta_try: 'Wypróbuj za darmo' },
...
nl: {
    ...
    home: { badge: 'Gratis plan beschikbaar', title: 'Het complete AI-platform voor medische beeldvorming', subtitle: 'Multimodale fusie-AI analyseert 400+ pathologieën in 8 modaliteiten.', cta_pilot: 'Gratis registreren', cta_try: 'Gratis proberen' },
...
he: {
    ...
    home: { badge: 'תוכנית חינמית זמינה', title: 'פלטפורמת AI מלאה להדמיה רפואית', subtitle: 'AI רב-מודלי מנתח למעלה מ-400 פתולוגיות ב-8 מודליטיות.', cta_pilot: 'הרשמה חינם', cta_try: 'נסה בחינם' },
...
fa: {
    ...
    home: { badge: 'طرح رایگان موجود است', title: 'پلتفرم کامل هوش مصنوعی برای تصویربرداری پزشکی', subtitle: 'هوش مصنوعی چند وجهی بیش از 400 پاتولوژی را در 8 مودالیتی تحلیل می‌کند.', cta_pilot: 'ثبت‌نام رایگان', cta_try: 'رایگان امتحان کنید' },
...
ur: {
    ...
    home: { badge: 'مفت پلان دستیاب', title: 'میڈیکل امیجنگ کے لیے مکمل AI پلیٹ فارم', subtitle: 'ملٹی موڈل AI 8 طریقوں میں 400+ پیتھالوجیز کا تجزیہ کرتا ہے۔', cta_pilot: 'مفت رجسٹر کریں', cta_try: 'مفت آزمائیں' },
...
ta: {
    ...
    home: { badge: 'இலவச திட்டம் கிடைக்கும்', title: 'மருத்துவ இமேஜிங்கிற்கான முழுமையான AI தளம்', subtitle: 'மல்டி-மோடல் ஃபியூஷன் AI 8 முறைமைகளில் 400+ நோய்களை பகுப்பாய்வு செய்கிறது.', cta_pilot: 'இலவச பதிவு', cta_try: 'இலவசமாக முயற்சிக்கவும்' },
...
te: {
    ...
    home: { badge: 'ఉచిత ప్లాన్ అందుబాటులో ఉంది', title: 'వైద్య ఇమేజింగ్ కోసం పూర్తి AI ప్లాట్‌ఫారమ్', subtitle: 'మల్టీ-మోడల్ ఫ్యూజన్ AI 8 మోడాలిటీలలో 400+ పాథాలజీలను విశ్లేషిస్తుంది.', cta_pilot: 'ఉచిత నమోదు', cta_try: 'ఉచితంగా ప్రయత్నించండి' },
...
mr: {
    ...
    home: { badge: 'मोफत प्लॅन उपलब्ध', title: 'वैद्यकीय इमेजिंगसाठी संपूर्ण AI प्लॅटफॉर्म', subtitle: 'मल्टी-मोडल फ्यूजन AI 8 मोडॅलिटीजमध्ये 400+ पॅथॉलॉजीजचे विश्लेषण करते.', cta_pilot: 'मोफत नोंदणी', cta_try: 'मोफत वापरून पहा' },
...
sw: {
    ...
    home: { badge: 'Mpango wa Bure Unapatikana', title: 'Jukwaa Kamili la AI kwa Picha za Matibabu', subtitle: 'AI ya mchanganyiko inachunguza pathologies 400+ katika njia 8.', cta_pilot: 'Jiandikishe Bure', cta_try: 'Jaribu Bure' },
...
uk: {
    ...
    home: { badge: 'Безкоштовний план доступний', title: 'Повна AI-платформа для медичної візуалізації', subtitle: 'Мультимодальний ШІ аналізує 400+ патологій у 8 модальностях.', cta_pilot: 'Безкоштовна реєстрація', cta_try: 'Спробувати безкоштовно' },
