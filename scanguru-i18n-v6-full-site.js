...
en: {
    ...
    // ═══════════════════════════════════════════════════════════════════════════════
    cxr: {
        s051: 'ScanGuru is NOT: autonomous diagnosis · not a replacement for clinical judgment · not for life-threatening emergency triage · not for direct-to-patient interpretation without clinician mediation · not for unqualified personnel · not for any modality outside the validated list.',
        s050: 'Research Use Only — pending market-specific regulatory registration.',
        s049: '⚕️ Decision support only — not a medical diagnosis.',
        s048: 'Blog',
        s047: 'Case Studies',
        s046: 'API Reference',
        s045: 'Documentation',
        ...
        s002: 'CXR Analysis',
        s001: 'EN',
        features_subtitle: 'Comprehensive chest x-ray analysis powered by our proprietary ensemble AI architecture',
        ...
        subtitle: 'Comprehensive CXR analysis detecting 50 pathologies with our proprietary 5-model hybrid ensemble. Automated triage, clinical scoring systems, and instant PDF reports.',
        stat1_value: '50+',
