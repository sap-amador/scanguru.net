...
en: {
    ...
    metrics: {
        status_live: 'LIVE',
        status_network: 'ScanGuru medical-imaging network',
        preview_chip: 'PREVIEW DATA · CONNECT API TO GO LIVE',
        hero_eyebrow: 'Network telemetry',
        hero_title_pre: "A medical-imaging network that's",
        hero_title_accent: 'live, multilingual, and growing.',
        hero_sub: "Real usage from the ScanGuru pilot — scans analyzed, institutions onboarded, countries reached, and reports delivered in the reader's own language. Figures update automatically as the network grows.",
        c_scans: 'Scans analyzed', c_institutions: 'Institutions enrolled',
        c_countries: 'Countries reached', c_reports: 'Reports generated',
        geo_h: 'Geographic metrics', map_title: 'Where ScanGuru is being used',
        map_sub: 'glowing nodes = active sites · country distribution',
        lang_dist_h: 'Language distribution', lang_dist_sub: 'Reports delivered, by language',
        clin_h: 'Clinical metrics', clin_note: 'Scans by live modality',
        mix_h: 'Modality mix', mix_sub: 'Live modalities only',
        op_h: 'Operational metrics', op_note: 'Auto-refreshing',
        op_avg: 'Avg processing time (sec)', op_today: 'Scans today',
        op_week: 'Last 7 days', op_month: 'Last 30 days',
        vol_h: 'Daily volume', vol_sub: 'Scans analyzed · last 30 days',
        tat_h: 'Average turnaround', tat_sub: 'Seconds from upload to report · lower is better',
        cap_h: 'Platform capability', cap_note: 'What the platform can do today vs the roadmap',
        cap_live: 'live',
        cap_mod_k: 'Imaging modalities — 5 live, 9 in the demo, 17 on the roadmap.',
        cap_path_k: 'Pathologies — 50+ live across 5 modalities, on a roadmap to 400+.',
        cap_path_tag: 'ROADMAP TARGET 400+',
        cap_lang_k: 'Languages supported for dual-language reports — a genuine differentiator.',
        cap_lang_tag: 'DUAL-LANGUAGE PDF REPORTS',
        act_h: 'Recent activity', act_report_generated: 'Report generated',
        act_realtime: 'Real-time feed', act_sample: 'Sample feed (preview)',
        field_h: 'From the field', footer_note: 'Metrics reflect the ScanGuru pilot network.',
